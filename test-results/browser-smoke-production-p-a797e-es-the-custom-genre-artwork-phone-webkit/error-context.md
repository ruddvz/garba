...
- Name: browser-smoke.spec.mjs >> production player shell is stable, complete and uses the custom genre artwork
- Location: .github/browser/browser-smoke.spec.mjs:161:1

# Error details

```
Error: player should have no uncaught errors, failed same-origin requests or HTTP errors
  ...
  - generic [ref=e3]:
    ...
    - main [ref=e22]:
      - region "Now playing" [ref=e23]:
        - heading "Magal Bhavan Amangal Hari" [level=1] [ref=e24]
        - paragraph [ref=e26]: Geeta Rabari
      - region "Playback controls" [ref=e27]:
        ...
        - button "Save Magal Bhavan Amangal Hari to My Garba" [ref=e40] [cursor=pointer]
