...
- Name: browser-smoke.spec.mjs >> Search opens without clipping and closing restores focus to the opener
- Location: .github/browser/browser-smoke.spec.mjs:210:1

# Error details

```
Error: Search sheet should have no uncaught errors, failed same-origin requests or HTTP errors
  ...
  - generic [ref=e3]:
    - banner [ref=e7]:
      ...
      - navigation "Player tools" [ref=e9]:
        - button "Search songs" [active] [ref=e10] [cursor=pointer]
    ...
    - main [ref=e22]:
      - region "Now playing" [ref=e23]:
        - heading "Garbo" [level=1] [ref=e24]
        - paragraph [ref=e26]: Narendra Modi, Tanishk Bagchi, Dhvani Bhanushali
      - region "Playback controls" [ref=e27]:
        ...
        - button "Save Garbo to My Garba" [ref=e40] [cursor=pointer]
