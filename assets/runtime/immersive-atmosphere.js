(() => {
  ...
  const MODES = {
    ...
    crowd: { label: 'Courtyard', desc: 'Live ground energy & cheers', master: 0.22, events: 0.35, crowd: 0.85, clapping: 0, spatial: false },
    clapping: { label: 'Live Ground', desc: 'Rhythmic ground handclaps', master: 0.24, events: 0.35, crowd: 0, clapping: 0.85, spatial: false },
