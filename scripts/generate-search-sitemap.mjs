...
import { renderSearchSitemap, validateSearchSurfacePolicy } from './lib/validate-search-surface-policy.mjs';
...
if (unknownArgs.length) {
  ...
  if (!validation.ok) {
    ...
    if (committed !== generated) {
      fail('sitemap.xml is stale. Run `node scripts/generate-search-sitemap.mjs --write` and review the diff.');
    } else {
