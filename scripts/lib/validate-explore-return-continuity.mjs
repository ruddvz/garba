...
const checks = [
  ...
  [bridge.includes('window.parent === window') && bridge.includes('window.parent.location.origin === window.location.origin'), 'bridge must activate only for a verified same-origin parent'],
