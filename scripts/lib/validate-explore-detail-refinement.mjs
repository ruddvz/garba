...
console.log('✓ Explore detail hierarchy, verified release hero, release identity, album semantics, keyboard navigation, overflow cues and horizontal-only focus are protected');
